...
class VOCMLTDataset(torch.utils.data.Dataset):
    def __init__(
        self,
        root,
        mode,
        ...
        # Load class splits
        with open(
            os.path.join(self.root, "longtail2012/class_split.pkl"),
            "rb",
        ) as file:
        ...
        self.classes = []
        with open(
            os.path.join(self.root, "longtail2012/voc_labels.txt"),
            "r",
        ) as file:
